...
<p>
  Python Developer • Discord Bot Developer • Automation • Web Tools • Game Utilities
</p>
...
I'm a developer focused on building useful tools, automation systems and web applications.

I mainly work with **Python**, **Discord bots**, **backend APIs**, **automation scripts** and **game-related tools**.  
...
<img src="https://skillicons.dev/icons?i=python,fastapi,django,js,react,html,css,mysql,git,github,vscode" />
...
- **FastAPI / Django** — backend APIs and web applications
- **JavaScript / React** — frontend projects and interactive web tools
- **HTML / CSS** — layouts, pages and UI styling
- **MySQL** — database basics and project data storage
...
- **MongoDB**
- **deployment workflow**
- **cleaner full-stack project structure**
